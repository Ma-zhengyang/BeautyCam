...
public class SnowFlake {
    ...
    private final RandomUtil mRandom; // 随机控制器
    ...
    private SnowFlake(RandomUtil random, Point position, float angle, float increment, float flakeSize, Paint paint) {
        mRandom = random;
        mPosition = position;
